      ...
      return (
        ...
        >
          <View style={styles.topBar}>
            <View
              style={{ alignSelf: "center", position: "absolute", left: 20 }}
            >
          ...
          >
            <View style={styles.box}>
              ...
              <Text style={styles.boxtext}>
                ...
                aim to broaden news access to students by reporting current
                events in a simplified manner.{" "}
              </Text>
              <Text style={styles.boxtext}>
            ...
            <View style={styles.box}>
              ...
              <Text style={styles.boxtext}>
                ...
                2. Submit a summarized article of interest to you that is
                between 75 - 250 words. {"\n"}
                3. Congrats! It's that easy to be a published writer while
                making sure Gen Z is updated on current events.
              </Text>
            </View>
            <View style={styles.box}>
